    ...
    <footer>
        <div class="inner container">
            <div class="row">
                ...
                <div class="col-5 col-md-4 d-none d-md-block footer_hidden_blocks">
                ...
                <div class="col-7 col-md-4 d-none d-md-block footer_hidden_blocks">
                    <div class="section_title text_uppercase">
                        Connect with us
                    </div>
    ...
    <div class="footer_widget_2 text-center">
        Copyright &copy; 2020 Mainland Autoshop.
    </div>
