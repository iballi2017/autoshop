...
<!-- main content -->
<div class="diagnostic_home_service_page mt-5">
    ...
    <section class="booking-link py-3 mt-5">
        <div class="container">
            <div class="row">
                <div class="col-12 col-lg-8">

                    <span>Book an appointment with us today and enjoy the convenience of having us visit your home or
                        office to carry out a diagnostic check on your car. </span>

                </div>
                <div class="col-12 col-lg-4 text-center text-md-right">
                    <div class="link-wrapper p-3 text-center my-2">
                        <a href="home-service-form.php" class="">BOOK FOR HOME SERVICE</a>
                    </div>
                </div>
            </div>
        </div>
